...
import { CalendarDays, Users, TrendingUp, Newspaper } from "lucide-react"
    ...
    <div ref={sidebarRef} className="h-[calc(100vh-100px)] custom-scrollbar pr-2 sidebar">
      <Tabs defaultValue="trending" value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="confessions" className="space-y-4">
          <Card className="shadow-sm border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
            <CardHeader className="pb-2 border-b border-gray-100 dark:border-gray-700">
              <CardTitle className="text-lg font-semibold text-[#1d2b7d]">Campus Confessions</CardTitle>
            </CardHeader>
            <CardContent className="p-4">
              <div className="space-y-4">
                {confessions.map((confession, index) => (
                  ...
                  >
                    <p className="text-sm italic">&quot;{confession.text}&quot;</p>
                    <div className="mt-2 flex justify-between items-center">
                      <span className="text-xs text-gray-500">{confession.department}</span>
              ...
              <Button variant="outline" className="w-full mt-4 border-[#1d2b7d] text-[#1d2b7d] hover:bg-[#1d2b7d]/10">
...
const confessions = [
  {
    text: "I've been pretending to understand calculus all semester but I'm completely lost. Too afraid to ask for help now.",
    department: "Engineering",
    year: "Sophomore",
  },
  {
    text: "I accidentally called my professor 'mom' during office hours and now I can never go back.",
    department: "Psychology",
    year: "Junior",
  },
  {
    text: "I've been using the same coffee cup for two weeks without washing it. Dorm life is rough.",
    department: "Business",
    year: "Freshman",
  },
]
