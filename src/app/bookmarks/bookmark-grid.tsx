                    ...
                    <DialogContent className="sm:max-w-md dark:bg-gray-800 dark:border-slate-700">
                      ...
                      <div className="flex justify-end">
                        <Button
                          ...
                          className="bg-[#1d2b7d] hover:bg-[#1d2b7d]/90 dark:bg-[#1d2b7d] dark:hover:bg-[#1d2b7d]/90"
                        >
                          Create Group
                        </Button>
                      </div>
      ...
      <AnimatePresence>
        {filteredBookmarks.length === 0 && (
          ...
          >
            ...
            <Button className="mt-6 bg-[#1d2b7d] hover:bg-[#1d2b7d]/90 dark:bg-[#1d2b7d] dark:hover:bg-[#1d2b7d]/90">
